...
! UPARAM(10): 0 = Python-coupled controller, 1 = embedded F77 actor.
! This must happen before MPI_INTERCOMM_CREATE because solo runs have no
! Python rank on the other side of the communicator.
