...
class Runner: 
    ...
    vars_io_freq:int         = 100  ## Frequncy the save the data
...
class Simulation: 
    ...
    READCHKPT:int       = 1         # p076 # Restat from checkpoint
    CHKPFNUMBER:int     = 6         # p067 # Restart file number
    CHKPINTERVAL:int    = 5000      # p075 # Checkpiont saving frequency (number of time steps)
